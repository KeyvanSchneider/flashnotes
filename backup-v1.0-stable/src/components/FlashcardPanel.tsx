          ...
          {currentCard ? (
            <div className="max-w-2xl w-full">
              <div className="bg-gray-50 rounded-xl p-8 mb-6 text-center">
                ...
                <div className="text-xl text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: currentCard.question }} />
              </div>

              {showAnswer && (
                <div className="bg-blue-50 rounded-xl p-8 mb-6 text-center">
                  <h3 className="text-lg font-medium text-blue-800 mb-4">Réponse</h3>
                  <div className="text-xl text-blue-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: currentCard.answer }} />
                </div>
              )}
            ...
            {currentCard && (
              <div className="flex-1 p-4 overflow-y-auto min-h-0">
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  <div className="text-gray-700" dangerouslySetInnerHTML={{ __html: currentCard.question }} />
                </div>

                {showAnswer && (
                  <div className="bg-blue-50 rounded-lg p-4 mb-4">
                    <h4 className="font-medium text-blue-800 mb-2">Réponse</h4>
                    <div className="text-blue-700" dangerouslySetInnerHTML={{ __html: currentCard.answer }} />
                  </div>
                )}
